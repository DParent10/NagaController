...
**[⬇️ Download Latest Release (v0.2.1)](https://github.com/DParent10/NagaController/releases/latest)**
...
1. Download `NagaController-v0.2.1.dmg` from [Releases](https://github.com/DParent10/NagaController/releases/latest)
2. Open the DMG file
