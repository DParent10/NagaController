...
```bash
# Mount the DMG
open NagaController-v0.2.1.dmg
```
...
```bash
# Sign DMG
codesign --sign "Developer ID Application: Devin Parent (SUT6Y24T2J)" NagaController-v0.2.1.dmg

# Notarize
xcrun notarytool submit NagaController-v0.2.1.dmg --keychain-profile "notary-profile" --wait

# Staple
xcrun stapler staple NagaController-v0.2.1.dmg
```
